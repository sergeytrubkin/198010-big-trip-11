import {TYPES_EVENT_TRANSFER, TYPES_EVENT_ACTIVITY} from '../const.js';

const createTypeEvent = (type) => {
...
export const createTripEventsFormTemplate = () => {

  const typesEventTransferMarkup = TYPES_EVENT_TRANSFER
    .map((it) => {
      return createTypeEvent(it);
    })
    .join(`\n`);
